...
function App() {
  const protectedRoutes = [
    ...
    { path: "/accounts", element: <Account />, roles: ["Admin", "Staff", "Dentist"] },
    { path: "/manage-service", element: <ManageService />, roles: ["Admin", "Staff", "Dentist"] },
    ...
    { path: "/manage-medicine", element: <ManageMedicine />, roles: ["Admin", "Staff", "Dentist"] },
